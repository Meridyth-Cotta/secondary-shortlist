...
/* ======================= GRAMMAR ======================= */
{
  ...
  detail:{
    ...
    other_info:"Check the journey carefully: it is well north of central London. The roll of 1,321 exceeds the recorded capacity of 1,200, which is unexplained in the published sources.",
...
},
{
  ...
  detail:{
    headline_notes:[
      {tone:"crit", text:"<strong>In 2024, 2025 and 2026 every single place went to a boy already inside the 10 kilometre priority area.</strong> The out-of-area category has been empty three years running. For anyone living outside that radius, a qualifying address is a precondition rather than an advantage."},
...
},
{
  ...
  detail:{
    ...
    other_info:"Check the journey carefully: it is in the far south of London and for many families will involve at least one change. Academy within a single-school trust.",
...
},
{
  ...
  detail:{
    ...
    other_info:"In the far south of London, and from much of the capital there is no direct rail route. The admissions authority is the academy trust board rather than the school, and it redetermines arrangements annually.",
...
/* ======================= CE / FAITH ======================= */
{
  ...
  detail:{
    headline_notes:[
      ...
      {tone:"warn", text:"<strong>Living within 3.5 miles of the academy is the condition to check.</strong> For families just outside that radius, a short move is the smallest relocation of anything on this list that changes an outcome. The document defining the radius is referenced in the policy but missing from the published version — request it."}
    ],
...
},
{
  ...
  detail:{
    headline_notes:[
      {tone:"crit", text:"<strong>The two-mile zone gates the faith route.</strong> In 2026 a family outside the zone received one offer across the entire faith route and none at all on the open route. The same pattern held in 2025. Church commitment buys nothing here without moving."},
...
},
{
  ...
  detail:{
    ...
    other_info:"Richmond measures distance by walking route, so the practical distance reads longer than a map suggests. The faith definition is the most workable of the five and the deanery restriction is what decides it.",
...
},
{
  ...
  detail:{
    ...
    sixth_form:"Treat this as an 11 to 16 school, but confirm directly. The government school register and the local council both list it as 11 to 16, while the school's own website has sixth form pages. Students continue at a sister school for sixth form.",
...
},
{
  ...
  detail:{
    ...
    other_info:"Knowledge-rich classical curriculum with Latin from Year 7 for all pupils. Split site, with Years 7 to 11 on King Street and the sixth form on Bridge Avenue. Distance is largely irrelevant here except as a pupil premium or sibling qualifier.",
...
},
{
  ...
  detail:{
    ...
    other_info:"Because it has recently had vacancies, it is the one boys' school on this list where living further away has not recently been a barrier.",
...
},
{
  ...
  detail:{
    ...
    other_info:"Well served by rail and Underground at Blackfriars and Mansion House, and travel is covered for bursary holders at 95 per cent or more.\n<strong>Split site:</strong> Year 6 is taught at a separate junior school rather than at Blackfriars.",
...
},
{
  ...
  detail:{
    headline_notes:[
      {tone:"crit", text:"<strong>No help with fees based on what a family can afford.</strong> The school offers scholarships for talent, worth at most 20 per cent off the fees, and a child can hold only one. It does not offer bursaries, the kind of help that reduces fees for families on lower incomes. Nothing about bursaries appears anywhere on its website, in its scholarship booklet or in its admissions policy."},
      {tone:"warn", text:"<strong>One phrase on the school's website can give the wrong impression.</strong> It says scholarships are open to children of all backgrounds, regardless of financial circumstances. That means family income makes no difference to who gets one. It does not mean there is help for families who need it."},
    ...
    bursary_scholarship:"<strong>No means-tested bursary exists in any published document.</strong>\nNo income thresholds, no separate form, no deadlines, no full awards, no published proportion supported, no published spend. The stated ceiling is a 20 per cent scholarship.\n<strong>Why:</strong> the school is owned by Cognita, a company run for profit. Alleyn's School in Dulwich can offer large bursaries because it is a charity, but that help does not extend to Hampstead. When the partnership was announced in 2025, both sides talked about new buildings and technology and said nothing about financial help.\n<strong>Worth asking directly:</strong> write to admissions and ask whether any bursary exists or is planned for September 2028, and request the scholarship pack. The website is silent rather than explicit, and the arrangement is new enough that this could still change.",
    numbers_rows:[
...
},
{
  ...
  flags:[{text:"No bursary exists · resolved",tone:"crit"},{text:"Small classes, max 22",tone:"good"}],
  detail:{
    headline_notes:[
      {tone:"crit", text:"<strong>Discounts for talent, but no help based on what a family can afford.</strong> The school offers scholarships, which take at most 20 per cent off the fees and are awarded for talent. It does not offer bursaries, which is the kind of help that reduces fees for families on lower incomes. Its own policy says scholarships are there to recognise talent, not to help families with fees."},
      {tone:"crit", text:"<strong>That is because the school is run as a business.</strong> It is owned by a private company rather than a charity, so there is no fund set aside for financial help, and nothing on the school's website suggests that will change."},
      {tone:"good", text:"<strong>On the plus side, getting in is less daunting than at the other independents.</strong> The interview is a short presentation on anything the child loves, and it comes before the test rather than after. Classes are capped at 22, and the school has plenty of spare places, being only about a third full."}
    ],
...
{
  id:"st-pauls", cat:"indep", name:"St Paul's School",
  location:"Barnes, SW13 \u00b7 boys",
  criteria_short:"ISEB pre-test with reasoning, then the school's own English and maths papers, then interview. Year 7 is in the Prep School.",
  fees_per_term:"\u00a310,221 inc VAT \u00b7 \u00a330,663 a year in Years 7\u20138 (2026/27)",
  next_open_day:"Saturday 19 September 2026 \u00b7 11+ Open Day",
  flags:[{text:"Year 7 in the Prep School",tone:""},{text:"Tests VR and NVR",tone:""},{text:"59 pupils on full bursaries",tone:"good"},{text:"Choose 11+ or 13+, not both",tone:"crit"}],
  detail:{
    headline_notes:[{tone:"warn", text:"<strong>At Year 7, boys join St Paul's Prep School, not the senior school.</strong> About 36 boys are admitted at eleven. They spend Years 7 and 8 in the Prep School, on the same Barnes site, and move up to St Paul's School in Year 9 without sitting another entrance exam. The admissions policy makes that move conditional on good work, conduct and meeting the senior school's academic standard, and in the latest published figures about 95 per cent of leavers went on."},{tone:"crit", text:"<strong>You must choose between the 11+ and the 13+ routes. You cannot apply for both.</strong> The 13+ route is now also assessed in the autumn of Year 6, so for a boy entering Year 7 in 2028, both routes would be tested in autumn 2027 and families have to pick one."},{tone:"good", text:"<strong>Substantial help with fees.</strong> Around 144 pupils hold means-tested bursaries, 59 of them on 100 per cent, with about \u00a33.5 million a year spent on them. Households earning under about \u00a378,000 may qualify for full fees, subject to assets, and the indicative ceiling runs to \u00a3144,000."},{tone:"warn", text:"<strong>Fees rise sharply at Year 9.</strong> The Prep School costs \u00a330,663 a year, and the senior school \u00a337,998, so the bill goes up by about \u00a37,300 a year when a boy moves up."}],
    criteria_detail:"Three stages at 11+.\nFirst, the ISEB Common Pre-Test in the autumn of Year 6, sat once only, either at the boy's own school if it is a test centre or at St Paul's.\nSecond, for candidates who do well enough, the school's own written English and maths papers, sat in person in December. References from the current school are requested at this stage.\nThird, an interview with senior staff and the Head, with parents meeting the Head at the same time. The admissions policy also mentions a group assessment.\nWeighting between the stages is not published, but candidates are expected to perform competently in all three, and where places are limited offers go in rank order. A strong recommendation from the current headteacher is required.\n<strong>There is no sibling priority and no priority for sons of former pupils</strong> \u2014 they are assessed alongside everyone else. The school says its 11+ entry is focused on children from state primaries and prep schools that finish at eleven.\n<strong>Everyone with legal responsibility for the child must consent to registration.</strong>",
    banding:"Not applicable.",
    alternative_entry:"<strong>No academic scholarships at 11+.</strong> Boys already in the Prep School are considered automatically for academic scholarships at 13+, which are honorary and worth \u00a360 a year.\n<strong>Music awards at 11+.</strong> A scholarship brings \u00a360 a year and free lessons on two instruments; an exhibition brings free lessons on one. The expected standard is <strong>above grade 5 on the main instrument</strong>, or grade 6 for piano, with a similar standard on a second instrument. The audition covers two contrasting pieces on the main instrument, one on the second, aural tests including singing, sight-reading and an interview. For the current cycle, applications closed in December and auditions were in early February.\n<strong>New sports awards from autumn 2026</strong> for 11+ entrants who meet the academic standard, with a linked founder's award for sporty boys who qualify for a 75 to 100 per cent bursary. Number and value are not published.\nThe school also funds a 100 per cent bursary for the highest-performing boy at 11+.\nArt scholarships start at 13+, not 11+.",
    exam_detail:"<strong>Stage one is the ISEB Common Pre-Test, which includes verbal reasoning and non-verbal reasoning</strong>, alongside English and maths. It is online, adaptive and multiple choice, and lasts about two and a quarter hours.\n<strong>Stage two is the school's own written papers,</strong> and these do not include reasoning:\nEnglish comprehension and analysis, 50 minutes, on an unseen passage of prose, drama or poetry.\nEnglish composition, 35 minutes.\nMaths, one 60-minute paper without a calculator, in three equal sections: multiple choice, calculations, and harder problem-solving. It is pitched at Key Stage 2 and excludes algebra, probability, averages and protractor work.\nPast papers are not released, but a syllabus is published.\nStage three is the interview, in person.",
    timeline_rows:[["11+ Open Day","19 September 2026","Confirmed \u00b7 aimed at the year above"],["Term-time morning visits","~March and June 2027","Projected"],["Registration opens","~w/c 19 April 2027","Projected"],["ISEB pre-test registration opens","~June 2027","Projected"],["Registration closes, and bursary box","~mid-October 2027","Projected \u00b7 also the bursary deadline"],["ISEB pre-test at St Paul's","~mid-November 2027","Projected"],["Written English and maths","~early to mid-December 2027","Projected"],["Interviews","~mid-January 2028","Projected"],["Offers","~mid-February 2028","Projected"],["Acceptance deadline","~early March 2028, midday","Projected"]],
    costs_rows:[["Registration exam fee","\u00a375, non-refundable",1],["Acceptance fee","\u00a3150 inc VAT",1],["Deposit","\u00a33,300, returned when he leaves",1],["Deposit on a bursary","\u00a3200, or none on a 100% award",1],["Prep School, Years 7\u20138","\u00a310,221 a term \u00b7 \u00a330,663 a year",1],["Senior school, from Year 9","\u00a312,666 a term \u00b7 \u00a337,998 a year",1]],
    deadlines_note:"<strong>The bursary deadline is the registration deadline.</strong> There is no separate date: you tick the bursary box when registering, and forms follow later. Miss the box and there is no second chance.\nIn the cycle for 2027 entry, the school moved its tests about four weeks earlier than before, into November and December rather than January. Whether it keeps that pattern for 2028 is not yet known, so treat every date above as a projection.\nAll fees shown are for 2026/27 and include VAT. Two more annual reviews will come before September 2028.",
    performance_rows:[["GCSE grade 9","72% (2026)",1],["GCSE 9\u20137","99% (2026)",1],["A level A*","60% (2026)",1],["A level A*\u2013A","91.5% (2026)",1],["All A or better","77% of pupils (2026)",1],["Inspection","All standards met, January 2025",0]],
    destinations_rows:[["Oxford and Cambridge 2025","38 to 44 leavers \u00b7 over a quarter",1],["Russell Group","95% of UK-bound leavers",1],["United States","33 places in 2025",1],["Medicine and dentistry","8 in 2025",1]],
    bursary_scholarship:"<strong>Bursaries cover 5 to 100 per cent of fees.</strong> About 144 pupils hold one, roughly one in ten across the school, and 72 per cent of those are on full fees or more than 75 per cent. 59 pupils are on 100 per cent awards. Means-tested bursaries cost the school about \u00a33.5 million in the most recent year, and it has a fundraising target to reach about 151 pupils.\n<strong>Indicative thresholds.</strong> Household income up to about \u00a3144,000 and net assets up to about \u00a31.6 million may qualify. Income below about \u00a378,000 may qualify for up to 100 per cent, subject to assets. There is a \u00a315,000 allowance for each other dependent child, and an online eligibility calculator.\n<strong>How the school assesses.</strong> It looks at earnings, assets, property value, savings and investments. It expects families to release equity if the home is considered too large or in an expensive area, to use equity in any second home, and for both parents to work if they can.\n<strong>Both separated parents are assessed,</strong> unless there is a strong reason not to.\n<strong>Eligibility rules.</strong> The family must have lived within 20 kilometres of the school, in a straight line, for at least a year when applying, and must keep doing so. Parents and child must be British or Irish citizens, hold indefinite leave to remain or settled status, or have long-term residency on a suitable visa.\nThe award is confirmed before the acceptance deadline, reviewed every year, and there is no appeal. Home visits may happen.\n<strong>Extras are covered at the same percentage as the fees:</strong> uniform and sports kit, trips, school transport, music lessons, Duke of Edinburgh, exam fees and books.",
    numbers_rows:[["Year 7 places","about 36",1],["Year 9 intake","198, roughly half from the Prep School",1],["Total roll","about 1,510 \u00b7 about 500 Prep, 1,010 senior",1],["Applicants per place","Not published",1],["School's own description","Very heavily over-subscribed at all points of entry",1]],
    sixth_form:"Yes, called the Eighth Form. <strong>Boys only</strong> \u2014 girls are not admitted at 16, and the school's charitable objectives restrict admission to boys. About 15 to 20 boys join from outside each year. Average class size is 8 to 10, with a maximum of 15. Entry needs at least eight GCSEs at grade 7, including at least six at grade 8 or 9, and the A level subjects chosen. All students take four A levels.",
    population_rows:[["Gender","Boys only, including the sixth form",1],["Ethnicity","Not published",1],["Pupils on a means-tested bursary","about 144, roughly 10%",1],["On 100% bursaries","59",1],["Boarding","Senior school only, from Year 9 \u00b7 none in the Prep School",1],["Religious character","Church of England",1],["Roll against capacity","about 1,504 against 1,600",1]],
    dei:"<strong>No independent school on this list publishes the ethnic make-up of its pupils,</strong> and St Paul's is no exception.\nThe school has a <strong>named Head of Diversity, Equity and Inclusion</strong> and a named governor with responsibility for inclusion. Its diversity, equity and inclusion policy was last reviewed in June 2026 and covers all nine protected characteristics, including positive action in recruitment.\nA strategy launched in 2023 has six priorities: understanding the community through data, marketing and brand, recruitment, the student experience, the employee experience, and <strong>active anti-racism</strong>.\nPupil and staff groups include an Inclusion Alliance of staff and students, an African and Caribbean Society, a Feminism Society, a Christian Union, a Hindu society, a pupil diversity society and a values committee. LGBTQ+ History Month and Black History Month are marked, and Year 9 hold a joint diversity day with St Paul's Girls' School.\nOn staff diversity, only the gender pay gap is published: a median hourly gap of 34.2 per cent in April 2025, with women making up 23 per cent of the top pay quarter and 62 per cent of the lowest. No staff ethnicity data is published.\nThe January 2025 inspection describes a welcoming and respectful community and a curriculum that builds understanding of the harm caused by discrimination and prejudice.\n<strong>Parents will likely come across two episodes in the school's recent history.</strong> In January 2020, an independent review of historic abuse found 80 complaints against 32 former staff over six decades, mostly from the 1960s to the 1990s, and made 28 recommendations. In April 2021, the school was named many times on the Everyone's Invited website, with allegations about misogyny, image sharing and sexual assault, often at parties away from school. The school condemned what was described, informed police and children's services, and reviewed its relationships curriculum. A focused inspection in November 2021, asked to look at safeguarding and a culture of respect, found all standards met and noted a strong action plan on school culture. No further controversy about the school's culture was found from 2022 to September 2026.",
    open_days_detail:"11+ Open Day on Saturday 19 September 2026, with talks from the High Master and the Head of the Prep School followed by pupil-led tours, designed with children in mind. Booked online. That event is aimed at the year above, but it is open.\nTerm-time morning visits have run in March and June. Private tours are not published. A virtual tour and a bursary webinar are online.",
    other_info:"<strong>Transport.</strong> The school runs coaches for Prep School pupils on routes including St John's Wood and Maida Vale, Notting Hill and Holland Park, Knightsbridge and South Kensington, Victoria, Chelsea and Fulham, Wimbledon and Putney, and Vauxhall and Battersea.\n<strong>Site.</strong> 45 acres beside the Thames in Barnes. The senior school was rebuilt by 2020 and a new Prep School building opened in January 2026, when St Paul's Juniors was renamed St Paul's Prep School.\n<strong>Leadership.</strong> The High Master, in post since 2020, is the first woman in the role.\n<strong>Recent changes.</strong> A St Paul's School Group formed at the end of 2025 with several prep schools, giving their pupils a pathway to 13+ entry. The 11+ test stages moved earlier in the most recent cycle.\nThe school has not submitted results to media league tables since 2008.",
    sources:["https://www.stpaulsschool.org.uk/admissions/entry-to-st-pauls-11/", "https://www.stpaulsschool.org.uk/admissions/fees/", "https://www.stpaulsschool.org.uk/admissions/founders-awards-bursaries/", "https://www.stpaulsschool.org.uk/wp-content/uploads/2025/12/11-plus-syllabus-2026.pdf", "https://www.stpaulsschool.org.uk/about-st-pauls/diversity-equality-inclusion/", "https://www.stpaulsschool.org.uk/wp-content/uploads/2025/02/St-Pauls-School-ROU-Report-v5-2025-02-35.pdf"]
  }
}
];
...
window.OPENDAYS = [
 ...
 {iso:"2026-09-19", when:"Sat 19 September", school:"St Paul's School", cat:"indep", event:"11+ Open Day, talks and pupil-led tours", note:"Aimed at the year above, but open"},
...
window.OPENDAYS_PENDING = [
 {school:"St Paul's School", cat:"indep", note:"Term-time morning visits have run in March and June. Private tours are not published."},
