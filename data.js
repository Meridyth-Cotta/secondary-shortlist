...
},
{
  ...
  detail:{
    headline_notes:[
      ...
      {tone:"crit", text:"<strong>The commute is the real constraint, not the fees.</strong> For families in north or west London, the journey can run to 75 to 90 minutes each way, two and a half to three hours a day, for a child whose documented difficulty involves sustained attention under fatigue. The guidance given to parents is that ninety minutes each way is too much at eleven."},
